  ...
  return (
    <section className="bg-background py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        {/* 1. Certificate */}
        <Reveal className="mb-16 grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        {/* 4. Lifetime warranty */}
        <Reveal className="grid gap-8 rounded-xl bg-primary p-6 text-primary-foreground sm:p-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
